/**
 * ========================================================
 * 🎨 Nalsh Storefront Dynamic Configuration Schema v3.0
 * مخطط ومواصفات إعدادات تخصيص المتجر ومولد القوالب
 * ========================================================
 */
...
export const DEFAULT_STOREFRONT_CONFIG = {
    ...
    products_settings: {
        ...
        show_currency: true,
        show_actions: true,
        // 📱 ملف التخصيص الكامل والمستقل لشاشات الجوال
        portrait: {
            ...
            card_custom_width: 0, // 0 = auto (155px)
            card_custom_height: 0, // 0 = auto
            img_custom_height: 0, // 0 = auto
        ...
        // 💻 ملف التخصيص الكامل والمستقل للشاشات الكبيرة والكمبيوتر
        landscape: {
            scroll_direction: 'horizontal',
            grid_columns: 4,
            grid_rows: 0,
            slider_rows: 1,
            card_orientation: 'portrait',
            card_custom_width: 0, // 0 = auto (190px)
            card_custom_height: 0, // 0 = auto
            img_custom_height: 0, // 0 = auto
            card_density: 'standard',
            show_badges: true,
...
export function sanitizeStorefrontConfig(inputConfig = {}) {
    if (!inputConfig || typeof inputConfig !== 'object') {
        return { sanitizedConfig: JSON.parse(JSON.stringify(DEFAULT_STOREFRONT_CONFIG)) };
    }
